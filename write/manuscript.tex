...
%
In the upper part of the outer layer, around $y^+\approx 1000$, no clearly visible signature of the
...
%
This precludes a drag law with wherewith we begin this section (\ref{sec:drag-law}).
...
for the streamwise (Sec.~\ref{sec:streamwise}) and spanwise components (Sec.~\ref{sec:spanwise})
...
we understand this as the manifestation of a mismatch between the theoretical treatment of the inner and outer layer of
