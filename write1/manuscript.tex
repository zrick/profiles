...
\begin{figure}
  ...
  \caption{Coefficients $a_\text{log}$, $b_\text{log}$ and $c_\log$ (cf. Eq.~\ref{eqn:abc_log}) as a function of 
...
%
Comparing our proposed formulation for the stream-wise velocity in the inner layer to  \citeauthor{vandriest:JOT1956}'s formulation 
