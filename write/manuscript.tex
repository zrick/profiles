...
%
\begin{eqnarray}
  \nu_E^-=\nu_E^+  \frac{Z_{\star}}{\delta^+} = \nu_E \frac{1}{\nu} \frac{G}{u_\star}\frac{\nu}{u_\star \delta}  = \nu _E \frac{Gf}{u_\star^3}. 
\end{eqnarray}
%
Substantial variation of the profiles is, however observed below and above this minimum for different $\RE$ which illustrates that
this normalization is probably not generally appropriate across the outer layer.
% 
\par
%
...
%
Finally in the upper part of the outer layer, around $y^+\approx 1000$, no clear visual signature of the
