...
The coordinate $O_y$ points away from the wall,  and $Oz$ points in the span-wise direction normal to $Oxy$. 
%
...
\begin{subequations}
  ...
  \item In the logarithmic region, we use the profile
    ...
    \end{equation}
    with $\kappa=0.416$ and $C=5.4605$. %  log-layer (K\'arm\'an, Prandtl, Jimenez, Marusic)
