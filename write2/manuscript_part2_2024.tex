...
\begin{abstract}
  ...
  Theoretical profiles of the wind vector are compared to the theoretical reference at intermediate Re, which necessitates consideration of viscous effects % [not required in abstract] (usually neglected in LES) a
