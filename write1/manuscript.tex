...
%%%
%%% ADD REFERENCE TO Klein and Maier (PAMM, 2021) for failure of matching of profile in 1D ODT-LES
%%% ADD REFERENCE TO Lindevall and Svensson (QJRMS, 2019, vol 145)
%%%
...
of \quotation{\emph{fully developed turbulence}  believed to occur for a sufficiently large but finite Reynolds number}
...
geostrophic wind $G$) governs the inviscid, i.e. $\RE$-independent,
normalization.
